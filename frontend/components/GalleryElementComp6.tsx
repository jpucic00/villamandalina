...
const GalleryElementComp6 = ({ device, title, image1, image2, image3, image4, image5, image6, sectionLabel }: Props) => {
  ...
  return (
    <div className={`galleryElementWrapper ${device}`}>
      ...
      {images.map((img, i) => (
        ...
        >
          {({ ref, open }) => (
            <div ref={ref} onClick={open} className={`gallery6ItemImage_${i + 1}`}>
              <img
